...
export function parseEmptyObjectInput(input: unknown): void {
...
export function parseCalculateInput(input: unknown): CalculateToolInput {
  return parseWithSchema(input, calculateInputSchema);
}

export function parseSaveMemoryInput(input: unknown): SaveMemoryToolInput {
...
export function parseMemorySearchInput(input: unknown): MemorySearchToolInput {
...
export function parseWebSearchInput(input: unknown): WebSearchToolInput {
...
export function parseWebFetchInput(input: unknown): WebFetchToolInput {
