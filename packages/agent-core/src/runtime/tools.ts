...
import {
  ...
  parseWebFetchInput,
  parseWebSearchInput,
} from "./tool-input-parsers.js";
import type { BuildSharedToolRuntimeOptions, SharedToolRuntime } from "./types.js";
export type { BuildSharedToolRuntimeOptions, SharedToolRuntime } from "./types.js";

export function createSharedToolRuntime(
  options: BuildSharedToolRuntimeOptions = {},
): SharedToolRuntime {
