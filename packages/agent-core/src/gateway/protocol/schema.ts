...
export function parseGatewayInboundFrame(value: unknown): GatewayInboundFrame {
  return gatewayInboundFrameSchema.parse(value);
}

export function parseGatewayOutboundFrame(value: unknown): GatewayOutboundFrame {
